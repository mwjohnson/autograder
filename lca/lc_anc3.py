...
def process_wordrank(anc_all_filename="anc_all_count.txt"):
...
def main(lemlines, filename, wordranks, adjdict):
    ...
    return {"filename": filename, "wordtypes": len(wordtypes.keys()), "swordtypes": len(swordtypes.keys()),
            "lextypes": len(lextypes.keys()), "slextypes": len(slextypes.keys()), "wordtokens": wordtokens,
            ...
            "ls1": slextokens / float(lextokens), "ls2": len(swordtypes.keys()) / float(len(wordtypes.keys())),
            ...
            "cttr": len(wordtypes.keys()) / sqrt(2 * wordtokens), "rttr": len(wordtypes.keys()) / sqrt(wordtokens),
            ...
            "lv": len(lextypes.keys()) / float(lextokens), "vv2": len(verbtypes.keys()) / float(lextokens),
            "nv": len(nountypes.keys()) / float(nountokens), "adjv": len(adjtypes.keys()) / float(lextokens),
...
if __name__ == '__main__':
    ...
    wordranks, adjdict = process_wordrank()
    result = main(read_file(), filename, wordranks, adjdict)
    print(result)
